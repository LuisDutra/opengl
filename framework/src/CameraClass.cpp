...
void CameraClass::Render() {
  ...
  MatrixRotationYawPitchRoll(roatationMatrix, yaw, pitch, roll);

  TransformCoord(lookAt, roatationMatrix);
  TransformCoord(up, roatationMatrix);
...
void CameraClass::MatrixRotationYawPitchRoll(float *matrix, float yaw,
...
void CameraClass::BuildViewMatrix(float *matrix, VectorType position,
